        ...
        <section className="max-w-6xl mx-auto p-6 grid grid-cols-3 gap-12 mt-24 py-12">
            ...
            <div className="flex flex-col gap-6 text-[var(--foreground)] col-span-2">
                ...
                <div className="flex items-center gap-6">
                    <p className="text-xl line-through text-gray-400">Rp {book.price.toLocaleString()}</p>
                    <p className="text-2xl font-extrabold text-[var(--primary)] px-6 py-2 border-2 border-[var(--primary)] rounded-full">Rp {formatNumber(book.price * ((100 - book.discount_percent) / 100))}</p>
                ...
                <div className="mt-12 space-y-6">
                    <div className="flex border-b border-gray-400">
                        <button
                            ...
                            className={`px-6 py-2 font-semibold text-sm ${activeTab === 'deskripsi'
                    ...
                    {activeTab === 'deskripsi' ? (
                        ...
                        <div className="grid grid-cols-2 gap-y-6 gap-x-12 text-sm text-[var(--foreground)]">
                            <div className='flex flex-col gap-2'>
                                ...
                                <p className='text-sm flex flex-row flex-wrap items-center gap-2'>
                                    {categories?.map((category, key) => (
                                        <p key={key} className='px-6 py-2 border-2 border-[var(--primary)] rounded-full'>
                                            {category.name}
                                        </p>
                                    ))}
                                </p>
            ...
            <h2 className="text-2xl text-[var(--foreground)] font-extrabold flex flex-row items-center gap-2"><FontAwesomeIcon icon={faShop} className="text-sm text-[var(--foreground)]" />Recommended Book</h2>
